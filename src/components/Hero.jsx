  ...
  return (
    ...
    <section className="min-h-screen flex flex-col lg:flex-row items-center justify-center gap-10 text-black lg:mt-4 mt-6 px-6">
        ...
        <div className="flex flex-row flex-wrap items-center justify-center lg:gap-8 gap-4 mt-10">
            <button className='button'>KPI Details</button>
        ...
        <img src={Main} alt="" className='lg:h-90 lg:w-[700px] h-40 w-full object-cover border-2 border-black rounded-2xl shadow-2xl' />
        <img src={IT} alt="" className='lg:h-40 lg:w-40 h-12 w-12 rounded-full object-cover border-2 border-black shadow-2xl  absolute lg:top-[-50px] lg:left-[-10px] top-[-10px] left-[-10px] z-50' />
